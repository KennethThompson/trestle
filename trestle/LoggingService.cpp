...
namespace trestle {
	void LoggingService::log(LOGLEVEL log_level, std::string script_path, std::string msg)
	{
	...
	void LoggingService::log(LOGLEVEL log_level, std::string msg)
	{
		log(log_level, "", msg);
	}
	void LoggingService::log_error(std::string msg)
	{
